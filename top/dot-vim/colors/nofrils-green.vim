" Name: No Frils Green
" Stolen from Author: robertmeta (on Github)
...
let g:colors_name = "nofrils-green"
...
function! NofrilsFocusComments()
    ...
    if g:nofrils_heavycomments
        hi Comment term=NONE cterm=NONE ctermfg=34 ctermbg=NONE gui=NONE guifg=#87005F guibg=NONE
    end
endfunction
...
function! NofrilsNormal()
    ...
    if g:nofrils_heavylinenumbers
        hi LineNr term=NONE cterm=NONE ctermfg=34 ctermbg=NONE gui=NONE guifg=#87005F guibg=NONE
    end
endfunction
