...
let g:colors_name = "nofrils-blue"
...
function! NofrilsFocusComments()
    ...
    if g:nofrils_heavycomments
        hi Comment term=NONE cterm=NONE ctermfg=12 ctermbg=NONE gui=NONE guifg=#87005F guibg=NONE
    end
endfunction
...
function! NofrilsNormal()
    ...
    if g:nofrils_heavylinenumbers
        hi LineNr term=NONE cterm=NONE ctermfg=12 ctermbg=NONE gui=NONE guifg=#87005F guibg=NONE
    end
endfunction
