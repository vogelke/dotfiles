...
"
" $Id: filetype.vim,v 1.4 2010/02/12 19:37:19 vogelke Exp $
" $Source: /home/vogelke/.vim/RCS/filetype.vim,v $
"
...
" Changelog
au BufNewFile,BufRead LOG setf remarklog
...
au BufNewFile,BufRead snd.\d\+,.letter,.letter.\d\+,.followup,.article,.article.\d\+,pico.\d\+,mutt-*-\w\+,mutt\w\{6\},/tmp/SLRN[0-9A-Z.]\+,*.eml setf mail
...
" Remind
au BufNewFile,BufRead .reminders*,*.rem		setf remind
