...
if &background == "dark"
  ...
  SynColor Statement	term=underline cterm=NONE ctermfg=LightGreen ctermbg=NONE gui=bold guifg=#60ff60 guibg=NONE
...
SynColor Todo	term=bold cterm=NONE ctermfg=Red ctermbg=NONE gui=NONE guifg=Blue guibg=NONE
